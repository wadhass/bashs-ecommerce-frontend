    ...
    <section className='h-screen flex items-center justify-center'>
                ...
                <form onSubmit={handleRegister} className='space-y-5 max-w-sm mx-auto p-8'>
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className={`w-full mt-5 bg-primary text-white font-medium py-3 rounded-md flex items-center justify-center gap-2 transition-transform duration-200 ${isLoading ? 'opacity-80 scale-95 cursor-wait' : 'hover:scale-105'}`}
                    >
                        {isLoading ? (
